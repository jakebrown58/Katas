...
var demoCode = require("../chopRecursive.js");

describe('Chop - Recursive - API Exists', function() {
...
describe('Chop - Recursive - Item in only position', function() {
...
describe('Chop - Recursive - Item not in only position', function() {
...
describe('Chop - Recursive - Item in first position', function() {
...
describe('Chop - Recursive - Item in last position', function() {
...
describe('Chop - Recursive - Item not in set', function() {
...
describe('Chop - Recursive - Public tests', function() {
