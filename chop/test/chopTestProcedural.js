...
var demoCode = require("../chopProcedural.js");

describe('Chop - Procedural - API Exists', function() {
...
describe('Chop - Procedural - Item in only position', function() {
...
describe('Chop - Procedural - Item not in only position', function() {
...
describe('Chop - Procedural - Item in first position', function() {
...
describe('Chop - Procedural - Item in last position', function() {
...
describe('Chop - Procedural - Item not in set', function() {
...
describe('Chop - Procedural - Public tests', function() {
